...
- notebook structure; focus on neuron -> layer -> deep network - > evaluation
    - mention LIF advantages; event-driven, asynchronous, etc
        - vs e.g. GRU with dense matmul
...
- introduce knobs to play with e.g. 
    - different sg slopes/shapes -> effect on spike rate observed or task performance
    - spike rate vs sg
    - spike rate vs initialization (e.g. higher explicit bias initialization)
